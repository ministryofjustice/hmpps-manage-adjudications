...
describe('GET /incident-role/<id>/edit', () => {
  it('should load the incident role edit page', () => {
    return request(app)
      .get(adjudicationUrls.incidentRole.urls.edit(100))
