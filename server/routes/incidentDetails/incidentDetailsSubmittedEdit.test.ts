...
describe('GET /incident-details/<PRN>/<id>/submitted/edit', () => {
  it('should load the incident details edit page with report referrer', () => {
    return request(app)
      .get(`/incident-details/G6415GD/5/submitted/edit?referrer=${prisonerReport.urls.report(1524455)}`)
...
describe('POST /incident-details/<PRN>/<id>/submitted/edit', () => {
  it('should redirect to offence details page - reporter', () => {
    return request(app)
      .post(`/incident-details/G6415GD/34/submitted/edit?referrer=${prisonerReport.urls.report(1524455)}`)
      .send({
  ...
  it('should render an error summary with correct validation message', () => {
    return request(app)
      .post(`/incident-details/G6415GD/34/submitted/edit?referrer=${prisonerReport.urls.review(1524455)}`)
      .send({
