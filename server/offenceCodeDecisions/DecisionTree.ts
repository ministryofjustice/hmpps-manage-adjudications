...
export default question([
    ...
    .child(question('What did the incident involve?')
      .child(answer('Assaulting someone')
        .child(question([
          ...
          .child(answer(['A person who’s left this establishment', `A person who's left this establishment - ${Text.VICTIM_PRISONER_OUTSIDE_ESTABLISHMENT}`]).type(Type.PRISONER_OUTSIDE_ESTABLISHMENT)
            .child(question('Was the incident a racially aggravated assault?')
  ...
  .child(answer('Detains another person')
    .child(question([
      ...
      .child(answer(['A person who’s left this establishment', `A person who's left this establishment - ${Text.VICTIM_PRISONER_OUTSIDE_ESTABLISHMENT}`]).type(Type.PRISONER_OUTSIDE_ESTABLISHMENT).offenceCode(2021))
