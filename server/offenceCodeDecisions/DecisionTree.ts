...
const CHILD_1_Q_V2 = 'Assault, fighting, endangering the health or personal safety of others, or sexually assault, expose or harassing someone'
...
const CHILD_6_Q_V2 = 'Disobeys any lawful order, or failure to comply with any rule or regulation, including a payback punishment' 
...
export const paragraph1AV2 = question('Who was assaulted?', adultPara1aYoiPara2OverrideQuestionIdV2)
.child(
  answer(['A prisoner in this establishment', `Another prisoner - ${Text.VICTIM_PRISONER_FULL_NAME}`])
    .type(Type.PRISONER)
