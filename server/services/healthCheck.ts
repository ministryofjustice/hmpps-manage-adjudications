...
const apiChecks = [
  ...
  service('manageAdjudicationsApi', `${config.apis.adjudications.url}/health/ping`, config.apis.adjudications.agent),
  service('curiousApi', `${config.apis.curious.url}/health/ping`, config.apis.curious.agent),
