...
const apiChecks = [
  ...
  service('prisonerSearch', `${config.apis.prisonerSearch.url}/health/ping`, config.apis.hmppsAuth.agent),
  service('prisonApi', `${config.apis.prison.url}/health/ping`, config.apis.hmppsAuth.agent),
  service('adjudications', `${config.apis.adjudications.url}/health/ping`, config.apis.hmppsAuth.agent),
