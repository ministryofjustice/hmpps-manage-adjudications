...
describe('placeOnReportService', () => {
  ...
  describe('getInfoForTaskListStatuses', () => {
    ...
    it('returns the correct response when there is no young offender flag', async () => {
      getDraftAdjudication.mockResolvedValue({
        draftAdjudication: {
          id: 104,
          prisonerNumber: 'G6415GD',
    ...
    it('returns the correct response when there are is no incident role', async () => {
      getDraftAdjudication.mockResolvedValue({
        draftAdjudication: {
          id: 104,
          prisonerNumber: 'G6415GD',
