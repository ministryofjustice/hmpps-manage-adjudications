...
describe('locationService', () => {
  ...
  describe('getIncidentLocations', () => {
    ...
    it('should sort retrieved locations with zero other locations', async () => {
      getLocations.mockReturnValue([
        { locationUuid: 'location-uuid-6', localName: 'Other cell' },
        { locationUuid: 'location-uuid-5', localName: "Prisoner's cell" },
      ])
  ...
  describe('getHearingLocations', () => {
    ...
    it('should assign internalLocationCode as userDescription when userDescription value is absent', async () => {
      getAdjudicationLocations.mockReturnValue([
        { locationUuid: 'location-uuid-2', key: 'ab', localName: undefined, prisonId: 'MDI' },
        { locationUuid: 'location-uuid-3', key: 'cd', localName: 'place 3', prisonId: 'MDI' },
        { locationUuid: 'location-uuid-1', key: 'ef', localName: 'place 1', prisonId: 'MDI' },
        { locationUuid: 'location-uuid-4', key: 'gh', localName: undefined, prisonId: 'MDI' },
      ])
    ...
    it('should sort retrieved locations alphabetically by userDescription', async () => {
      getAdjudicationLocations.mockReturnValue([
        { locationUuid: 'location-uuid-2', key: 'ab', localName: 'place-2', prisonId: 'MDI' },
        { locationUuid: 'location-uuid-3', key: 'cd', localName: 'place 3', prisonId: 'MDI' },
        { locationUuid: 'location-uuid-1', key: 'ef', localName: 'place 1', prisonId: 'MDI' },
        { locationUuid: 'location-uuid-4', key: 'gh', localName: 'place-4', prisonId: 'MDI' },
      ])
