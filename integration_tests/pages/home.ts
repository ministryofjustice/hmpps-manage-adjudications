...
export default class Home extends Page {
  ...
  viewScheduledHearingsCard = (): PageElement => cy.get('a').contains('Schedule hearings')
  ...
  enterOutcomesCard = (): PageElement => cy.get('a').contains('Manage hearings and enter outcomes')
}
