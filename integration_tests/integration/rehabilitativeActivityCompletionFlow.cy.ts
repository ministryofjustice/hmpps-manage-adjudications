...
context('Mark whether a rehabilitative activity has been completed', () => {
  ...
  describe('Not completed', () => {
    ...
    it('Validation 2', () => {
      ...
      incompleteRehabilitativeActivityPage.daysToActivate().type('beep')
      incompleteRehabilitativeActivityPage.submitButton().click()
      completeActivityPage.errorSummary().contains('The number of days for the punishment must be a number')
      incompleteRehabilitativeActivityPage.daysToActivate().clear().type('20')
      incompleteRehabilitativeActivityPage.submitButton().click()
      completeActivityPage.errorSummary().contains('The number of days for the punishment must be 10 or fewer')
    })
    ...
    it('Validation 3', () => {
      ...
      incompleteRehabilitativeActivityPage.suspendedUntil().type('06-01-2025')
      incompleteRehabilitativeActivityPage.submitButton().click()
      completeActivityPage.errorSummary().contains('The new date the suspended punishment will end must be a real date')
      incompleteRehabilitativeActivityPage.suspendedUntil().type('hello')
      incompleteRehabilitativeActivityPage.submitButton().click()
      completeActivityPage.errorSummary().contains('The new date the suspended punishment will end must be a real date')
    })
    it('Extend suspended', () => {
