...
context('Your Completed Reports', () => {
  ...
  it('pagination should work', () => {
    ...
    yourCompletedReportsPage.paginationResults().should('have.text', 'Showing 1 to 20 of 300 total results')
    yourCompletedReportsPage.paginationLink(1).should('have.attr', 'aria-current', 'page')
    ...
    yourCompletedReportsPage.nextLink().should('exist')
    yourCompletedReportsPage.paginationResults().should('have.text', 'Showing 181 to 200 of 300 total results')
    yourCompletedReportsPage.paginationLink(10).should('have.attr', 'aria-current', 'page')
    ...
    yourCompletedReportsPage.previousLink().should('exist')
    yourCompletedReportsPage.nextLink().should('exist')
    yourCompletedReportsPage.paginationResults().should('have.text', 'Showing 261 to 280 of 300 total results')
    yourCompletedReportsPage.paginationLink(14).should('have.attr', 'aria-current', 'page')
    ...
    yourCompletedReportsPage.paginationResults().should('have.text', 'Showing 281 to 300 of 300 total results')
    yourCompletedReportsPage.paginationLink(15).should('have.attr', 'aria-current', 'page')
    yourCompletedReportsPage.paginationLink(5).should('not.exist')
    yourCompletedReportsPage.paginationLink(6).should('exist')
    yourCompletedReportsPage.paginationLink(16).should('not.exist')
  })
  ...
  it('filtering should work', () => {
    ...
    yourCompletedReportsPage.paginationResults().should('have.text', '1 total results')
  })
  ...
  it('filtering and pagination should work together', () => {
    ...
    yourCompletedReportsPage.paginationResults().should('have.text', 'Showing 21 to 40 of 300 total results')
  })
