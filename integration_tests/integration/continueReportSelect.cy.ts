...
context('Continue a report - select report', () => {
  context('with data', () => {
    ...
    it('pagination should work', () => {
      ...
      continueReportSelectPage.paginationResults().first().should('have.text', 'Showing 1 to 20 of 300 total results')
      continueReportSelectPage.paginationLink(1).should('have.attr', 'aria-current', 'page')
      ...
      continueReportSelectPage
        .paginationResults()
        .first()
        .should('have.text', 'Showing 181 to 200 of 300 total results')
      continueReportSelectPage.paginationLink(10).should('have.attr', 'aria-current', 'page')
