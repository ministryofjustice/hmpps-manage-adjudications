  ...
  describe('Loads', () => {
    ...
    it('should contain the required page elements for forms for hearing - no outcomes', () => {
      ...
      formsTabPage
        .printLink('DIS3-type')
        .should('have.attr', 'href')
        .and('include', `/assets/pdf/v2/DIS%203%20-%20input%20version.pdf`)
      formsTabPage
        .printLink('DIS4-auto')
        .should('have.attr', 'href')
      ...
      formsTabPage
        .printLink('DIS4-type')
        .should('have.attr', 'href')
        .and('include', `/assets/pdf/v2/DIS%204%20-%20input.pdf`)
      formsTabPage
        .printLink('DIS5')
        .should('have.attr', 'href')
      ...
      formsTabPage
        .printLink('DIS6-type')
        .should('have.attr', 'href')
        .and('include', `/assets/pdf/v2/DIS%206%20-%20input.pdf`)
      formsTabPage
