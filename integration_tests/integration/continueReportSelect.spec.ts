  ...
  context('with data', () => {
        ...
        draftAdjudications: [
          {
            ...
            incidentDetails: {
              ...
              locationId: 233,
              modifiedByDateTime: '2021-11-17T09:40:00Z',
              modifiedByUserId: 'USER1',
            },
            incidentStatement: {
              completed: false,
              createdByUserId: 'USER1',
              createdDateTime: '2021-11-17T09:45:00Z',
              modifiedByDateTime: '2021-11-17T09:45:00Z',
              modifiedByUserId: 'USER1',
          ...
          },
          {
            ...
            incidentDetails: {
              ...
              locationId: 644,
              modifiedByDateTime: '2021-11-17T11:40:00Z',
              modifiedByUserId: 'USER1',
            },
            incidentStatement: {
              completed: false,
    ...
    it('should take you to the task list for the report you wish to continue', () => {
      ...
      cy.location().should(loc => {
        expect(loc.pathname).to.eq('/place-the-prisoner-on-report/G2996UX')
      })
    })
  })
